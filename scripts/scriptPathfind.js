            ...
            if (!((((min_i[0] + 1)) + '-' + min_i[1]) in a_visited)) {
                if ((min_i[0] + 1) < arr.length) {
                    if ((arr[(min_i[0] + 1)][min_i[1]] != -1)) {
                        a_table[((min_i[0] + 1) + '-' + min_i[1])].g = Math.sqrt(Math.pow(((min_i[0] + 1) - start[0]), 2) + Math.pow((min_i[1] - start[1]), 2)); // Distance from the start
                        a_table[((min_i[0] + 1) + '-' + min_i[1])].h = Math.sqrt(Math.pow(((min_i[0] + 1) - end[0]), 2) + Math.pow((min_i[1] - end[1]), 2)); // Distance from the end
                        a_table[((min_i[0] + 1) + '-' + min_i[1])].p = [min_i[0], min_i[1]];
                        a_visited[((min_i[0] + 1) + '-' + min_i[1])] = 1;
                    }
                }
            }
            if (!((((min_i[0] - 1)) + '-' + min_i[1]) in a_visited)) {
            ...
            if (!((((min_i[0])) + '-' + (min_i[1] + 1)) in a_visited)) {
                if ((min_i[1] + 1) < arr[0].length - 1) {
                    if ((arr[(min_i[0])][min_i[1] + 1] != -1)) {
                        a_table[((min_i[0]) + '-' + (min_i[1] + 1))].g = Math.sqrt(Math.pow((min_i[0] - start[0]), 2) + Math.pow(((min_i[1] + 1) - start[1]), 2)); // Distance from the start
                        a_table[((min_i[0]) + '-' + (min_i[1] + 1))].h = Math.sqrt(Math.pow((min_i[0] - end[0]), 2) + Math.pow(((min_i[1] + 1) - end[1]), 2)); // Distance from the end
                        a_table[((min_i[0]) + '-' + (min_i[1] + 1))].p = [min_i[0], min_i[1]];
                        a_visited[(min_i[0] + '-' + (min_i[1] + 1))] = 1;
                    }
                }
            }
            if (!((((min_i[0])) + '-' + (min_i[1] - 1)) in a_visited)) {
